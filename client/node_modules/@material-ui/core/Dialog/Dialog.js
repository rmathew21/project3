...
var styles = function styles(theme) {
  return {
    ...
    paperWidthXs: {
      ...
      '&$paperScrollBody': (0, _defineProperty2.default)({}, theme.breakpoints.down(Math.max(theme.breakpoints.values.xs, 444) + 48 * 2), {
        maxWidth: 'calc(100% - 96px)'
      })
    },
...
var Dialog = _react.default.forwardRef(function Dialog(props, ref) {
  ...
  var mouseDownTarget = _react.default.useRef();
  ...
  return _react.default.createElement(_Modal.default, (0, _extends2.default)({
    ...
    className: (0, _clsx.default)(classes.container, classes["scroll".concat((0, _helpers.capitalize)(scroll))]),
    ...
    className: (0, _clsx.default)(classes.paper, classes["paperScroll".concat((0, _helpers.capitalize)(scroll))], classes["paperWidth".concat((0, _helpers.capitalize)(String(maxWidth)))], PaperProps.className, fullScreen && classes.paperFullScreen, fullWidth && classes.paperFullWidth)
  }), children))));
});
